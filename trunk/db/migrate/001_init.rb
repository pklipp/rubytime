class Init < ActiveRecord::Migration
  def self.up
    ...
    User.create(:login => 'admin', :name => 'admin', :email => 'admin@test.site.com', :role_id => 1, :password => '7be43c1935a3d4ccd904a062a0e8925fb986829f', :salt => '287560120.570862222928554')
