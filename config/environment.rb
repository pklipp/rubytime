...
Rails::Initializer.run do |config|
  ...
  # options =  (:active_record_store, :p_store, drb_store, :mem_cache_store, or :memory_store) or your own custom class.
  # by default in cookies
  ...
  #config.gem "mislav-will_paginate", :lib => "will_paginate", :source => "http://gems.github.com", :version => "~> 2.3.3"
